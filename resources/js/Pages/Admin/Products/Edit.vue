...
const imageLabel = ref("Ajouter d'autres images");
  ...
  <AdminLayout :currentUrl="$attrs.ziggy.location">
    ...
    >
      <section
        ...
        ref="firstSection"
        :class="{
          'bg-alabaster bg-opacity-95 pb-2 xl:pb-3 z-10': !showNameInput,
        }"
      >
          ...
          <section class="px-5 py-6 flex flex-col md:flex-row gap-5">
            <div class="md:flex-auto">
              ...
              <label
                ...
                :class="{
                  'border border-red border-opacity-50': errors.images,
                }"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
